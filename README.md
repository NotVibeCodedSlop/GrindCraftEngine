...
then in some way delete the ?636391 and simular tags in the urls and get every one of them
...
## 2. Play
Beacuse this engine is 1 to 1 with the original you can now simply play.
